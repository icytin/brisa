...
-- Dumping database structure for brisa-system
CREATE DATABASE IF NOT EXISTS `brisa-system` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `brisa-system`;


-- Dumping structure for table brisa-system.attachments
...
-- Dumping data for table brisa-system.attachments: ~0 rows (approximately)
DELETE FROM `attachments`;
/*!40000 ALTER TABLE `attachments` DISABLE KEYS */;
/*!40000 ALTER TABLE `attachments` ENABLE KEYS */;


-- Dumping structure for table brisa-system.bccrecipients
...
-- Dumping data for table brisa-system.bccrecipients: ~0 rows (approximately)
DELETE FROM `bccrecipients`;
/*!40000 ALTER TABLE `bccrecipients` DISABLE KEYS */;
/*!40000 ALTER TABLE `bccrecipients` ENABLE KEYS */;


-- Dumping structure for table brisa-system.ccrecipients
...
-- Dumping data for table brisa-system.ccrecipients: ~0 rows (approximately)
DELETE FROM `ccrecipients`;
/*!40000 ALTER TABLE `ccrecipients` DISABLE KEYS */;
/*!40000 ALTER TABLE `ccrecipients` ENABLE KEYS */;


-- Dumping structure for table brisa-system.emails
...
-- Dumping data for table brisa-system.emails: ~0 rows (approximately)
DELETE FROM `emails`;
/*!40000 ALTER TABLE `emails` DISABLE KEYS */;
/*!40000 ALTER TABLE `emails` ENABLE KEYS */;


-- Dumping structure for table brisa-system.openhierarchy_background_modules
...
-- Dumping data for table brisa-system.openhierarchy_background_modules: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_background_module_aliases
...
-- Dumping data for table brisa-system.openhierarchy_background_module_aliases: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_background_module_groups
...
-- Dumping data for table brisa-system.openhierarchy_background_module_groups: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_background_module_settings
...
-- Dumping data for table brisa-system.openhierarchy_background_module_settings: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_background_module_slots
...
-- Dumping data for table brisa-system.openhierarchy_background_module_slots: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_background_module_users
...
-- Dumping data for table brisa-system.openhierarchy_background_module_users: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_data_sources
...
-- Dumping data for table brisa-system.openhierarchy_data_sources: ~1 rows (approximately)
...
INSERT INTO `openhierarchy_data_sources` (`dataSourceID`, `url`, `type`, `enabled`, `driver`, `username`, `password`, `name`, `logAbandoned`, `removeAbandoned`, `removeTimeout`, `testOnBorrow`, `validationQuery`, `maxActive`, `maxIdle`, `minIdle`, `maxWait`, `defaultCatalog`) VALUES
	(1, 'jdbc:mysql://164.9.214.245:3306/brisa-system', 'SystemManaged', 1, 'com.mysql.jdbc.Driver', 'ohuser', 'ohuser', 'Användardatabas', 1, 1, 30, 1, 'SELECT 1', 100, 30, 0, 10000, NULL);
/*!40000 ALTER TABLE `openhierarchy_data_sources` ENABLE KEYS */;


-- Dumping structure for table brisa-system.openhierarchy_filter_modules
...
-- Dumping data for table brisa-system.openhierarchy_filter_modules: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_filter_module_aliases
...
-- Dumping data for table brisa-system.openhierarchy_filter_module_aliases: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_filter_module_groups
...
-- Dumping data for table brisa-system.openhierarchy_filter_module_groups: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_filter_module_settings
...
-- Dumping data for table brisa-system.openhierarchy_filter_module_settings: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_filter_module_users
...
-- Dumping data for table brisa-system.openhierarchy_filter_module_users: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_foreground_modules
...
-- Dumping data for table brisa-system.openhierarchy_foreground_modules: ~20 rows (approximately)
...
INSERT INTO `openhierarchy_foreground_modules` (`moduleID`, `classname`, `name`, `alias`, `description`, `xslPath`, `xslPathType`, `anonymousAccess`, `userAccess`, `adminAccess`, `enabled`, `visibleInMenu`, `sectionID`, `dataSourceID`, `staticContentPackage`, `requiredProtocol`) VALUES
	(1, 'se.unlogic.hierarchy.foregroundmodules.login.UserProviderLoginModule', 'Logga in', 'login', 'Modul för inloggning', 'LoginModule.sv.xsl', 'Classpath', 1, 0, 0, 1, 1, 1, 1, 'staticcontent', NULL),
	...
	(21, 'com.brisa.modules.index.IndexModule', 'Start', 'firstpage', 'Startsidan', 'IndexModule.xsl', 'Classpath', 0, 1, 1, 1, 1, 1, NULL, 'staticcontent', NULL);
/*!40000 ALTER TABLE `openhierarchy_foreground_modules` ENABLE KEYS */;


-- Dumping structure for table brisa-system.openhierarchy_foreground_module_groups
...
-- Dumping data for table brisa-system.openhierarchy_foreground_module_groups: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_foreground_module_settings
...
-- Dumping data for table brisa-system.openhierarchy_foreground_module_settings: ~37 rows (approximately)
...
INSERT INTO `openhierarchy_foreground_module_settings` (`counter`, `moduleID`, `id`, `value`) VALUES
	...
	(2482, 21, 'menuItemType', 'MENUITEM');
/*!40000 ALTER TABLE `openhierarchy_foreground_module_settings` ENABLE KEYS */;


-- Dumping structure for table brisa-system.openhierarchy_foreground_module_users
...
-- Dumping data for table brisa-system.openhierarchy_foreground_module_users: ~1 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_menu_index
...
-- Dumping data for table brisa-system.openhierarchy_menu_index: ~45 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_sections
...
-- Dumping data for table brisa-system.openhierarchy_sections: ~2 rows (approximately)
...
INSERT INTO `openhierarchy_sections` (`sectionID`, `parentSectionID`, `alias`, `enabled`, `anonymousAccess`, `userAccess`, `adminAccess`, `visibleInMenu`, `breadCrumb`, `name`, `description`, `anonymousDefaultURI`, `userDefaultURI`, `requiredProtocol`) VALUES
	(1, NULL, 'firstpage', 1, 1, 1, 1, 1, 1, 'Förstasidan', 'Förstasidan...', '/login', '/firstpage', NULL),
...
-- Dumping structure for table brisa-system.openhierarchy_section_groups
...
-- Dumping data for table brisa-system.openhierarchy_section_groups: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_section_users
...
-- Dumping data for table brisa-system.openhierarchy_section_users: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_virtual_menu_items
...
-- Dumping data for table brisa-system.openhierarchy_virtual_menu_items: ~2 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_virtual_menu_item_groups
...
-- Dumping data for table brisa-system.openhierarchy_virtual_menu_item_groups: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.openhierarchy_virtual_menu_item_users
...
-- Dumping data for table brisa-system.openhierarchy_virtual_menu_item_users: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.pages
...
-- Dumping data for table brisa-system.pages: ~1 rows (approximately)
DELETE FROM `pages`;
/*!40000 ALTER TABLE `pages` DISABLE KEYS */;
/*!40000 ALTER TABLE `pages` ENABLE KEYS */;


-- Dumping structure for table brisa-system.page_groups
...
-- Dumping data for table brisa-system.page_groups: ~0 rows (approximately)
DELETE FROM `page_groups`;
/*!40000 ALTER TABLE `page_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `page_groups` ENABLE KEYS */;


-- Dumping structure for table brisa-system.page_users
...
-- Dumping data for table brisa-system.page_users: ~0 rows (approximately)
DELETE FROM `page_users`;
/*!40000 ALTER TABLE `page_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `page_users` ENABLE KEYS */;


-- Dumping structure for table brisa-system.recipients
...
-- Dumping data for table brisa-system.recipients: ~0 rows (approximately)
DELETE FROM `recipients`;
/*!40000 ALTER TABLE `recipients` DISABLE KEYS */;
/*!40000 ALTER TABLE `recipients` ENABLE KEYS */;


-- Dumping structure for table brisa-system.replyto
...
-- Dumping data for table brisa-system.replyto: ~0 rows (approximately)
DELETE FROM `replyto`;
/*!40000 ALTER TABLE `replyto` DISABLE KEYS */;
/*!40000 ALTER TABLE `replyto` ENABLE KEYS */;


-- Dumping structure for table brisa-system.simple_groups
...
-- Dumping data for table brisa-system.simple_groups: ~0 rows (approximately)
DELETE FROM `simple_groups`;
/*!40000 ALTER TABLE `simple_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `simple_groups` ENABLE KEYS */;


-- Dumping structure for table brisa-system.simple_group_attributes
...
-- Dumping data for table brisa-system.simple_group_attributes: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.simple_users
...
-- Dumping data for table brisa-system.simple_users: ~1 rows (approximately)
...
INSERT INTO `simple_users` (`userID`, `username`, `password`, `firstname`, `lastname`, `email`, `admin`, `enabled`, `added`, `lastlogin`, `language`, `preferedDesign`) VALUES
	(1, 'admin', '*4ACFE3202A5FF5CF467898FC58AAB1D615029441', 'Admin', 'Adminsson', 'admin@admin.com', 1, 1, '2014-10-15 21:27:00', '2015-07-09 15:31:23', NULL, NULL);
/*!40000 ALTER TABLE `simple_users` ENABLE KEYS */;


-- Dumping structure for table brisa-system.simple_user_attributes
...
-- Dumping data for table brisa-system.simple_user_attributes: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.simple_user_groups
...
-- Dumping data for table brisa-system.simple_user_groups: ~0 rows (approximately)
...
-- Dumping structure for table brisa-system.table_versions
...
-- Dumping data for table brisa-system.table_versions: ~4 rows (approximately)
